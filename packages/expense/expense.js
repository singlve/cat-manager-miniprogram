...
Page({
  ...
  editExpense(e) {
    wx.navigateTo({ url: '/packages/expense-add/expense-add?id=' + e.currentTarget.dataset.id });
  },
  ...
  goAdd() {
    wx.navigateTo({ url: '/packages/expense-add/expense-add' });
  },
  ...
  onShareAppMessage() {
    return { imageUrl: '/assets/logo.jpg', title: '把宠物的日常花销记录得更清楚', path: '/packages/expense/expense' };
  }
});
