...
const themedSurfaces = [
  'packages/shipping-address/shipping-address.wxss',
  'packages/feedback/feedback.wxss',
  ...
  'pet-package/cat-detail/cat-detail.wxss',
  'pet-package/cat-add/cat-add.wxss',
  'pet-package/health-records/health-records.wxss',
  'pet-package/weight-records/weight-records.wxss',
  'pages/reminders/reminders.wxss',
  'pet-package/reminder-add/reminder-add.wxss',
