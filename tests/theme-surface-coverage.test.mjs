...
const themedSurfaces = [
  ...
  'packages/services/admin-announcement/admin-announcement.wxss',
  'packages/services/admin-data/admin-data.wxss',
  'packages/services/admin-items/admin-items.wxss',
